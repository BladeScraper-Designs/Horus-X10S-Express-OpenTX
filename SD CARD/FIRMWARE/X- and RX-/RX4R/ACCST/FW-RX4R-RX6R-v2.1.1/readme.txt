...
This Package is for RX4R/RX6R ACCST v2.1.1 firmware update. 

Version and Files: 
RX6R_ACCST_V2.1.1_FCC.frk                              Firmware under NonLbt mode which is certificated for FCC rules. 
RX6R_ACCST_V2.1.1_LBT.frk                               Firmware under LBT mode which is certificated for CE rules.  
...
--------------------------------------------------------------------------------------------------------------------
v2.1.1
Fix the abnormal failsafe issue.
--------------------------------------------------------------------
v2.1.0
