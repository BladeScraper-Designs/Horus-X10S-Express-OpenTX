...
Version and Files: 
Archer-RS_2.1.7.frsk                          Firmware for Archer RS receiver.
...
--------------------------------------------------------------------------------------------------------------------
1. Fixed occasional signal delay when working with Betaflight flight control in race mode.
2. Increase the speed of OTA upgrades.
