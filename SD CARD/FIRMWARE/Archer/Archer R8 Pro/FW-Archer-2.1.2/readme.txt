...
This Package is for Archer firmware update. 

Version and Files: 
Archer-X_2.1.2.frsk               Firmware for Archer receivers.
...
--------------------------------------------------------------------------------------------------------------------
1. Support F.PORT2.0.
2. Fix the problem of random output in some channels after power on.
3. Fix the problem that the RSSI output does not update in F.ORT mode.
-------------------------------------------------------------------------------------------------------------------
