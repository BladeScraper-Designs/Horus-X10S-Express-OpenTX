...
This Package is for Radio ISRM module v2.1.6 firmware update. 

Version and Files: 
ISRM_S_X10E_2.1.6.frsk                            Upgrade file for internal module of X10 Express /X10S Express(not the upgrade module for X10/X10S).
...
Update to work with Archer RS 2.1.6 racing mode.

Compatibility
                                            |       ISRM Modules & ACCESS Radios
                                            |       (ACCESS 2.X.X or a later version)
--------------------------------------------------------------------------------------
Rx ACCESS 2.X.X	            |                      YES
...
https://www.frsky-rc.com/product/horus-x10-express/
https://www.frsky-rc.com/product/horus-x10s-express/
